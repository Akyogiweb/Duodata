...
// One "block" of table rows; we render two blocks stacked so the
// vertical scroll can loop seamlessly.
const TableBlock = ({ offset = 0 }) => (
  <table
...
const DataSourcesSection = () => {
  return (
    <section className="relative py-24 md:py-36 bg-white overflow-hidden">
      {/* Animated faded table background */}
      <div className="absolute inset-0 overflow-hidden">
        <div className="ds-table-marquee">
          <TableBlock offset={0} />
          <TableBlock offset={22} />
        </div>
        ...
        <div
          ...
          style={{
            background:
              'radial-gradient(ellipse at center, rgba(255,255,255,0.95) 0%, rgba(255,255,255,0.85) 30%, rgba(255,255,255,0.4) 60%, transparent 100%)',
          }}
        />
      </div>
