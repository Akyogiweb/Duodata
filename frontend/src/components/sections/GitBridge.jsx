  ...
  <section id="git" className="py-24 md:py-32 bg-slate-950 text-white">
    <div className="max-w-[1200px] mx-auto px-6">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        <div>
          <p className="text-[11px] tracking-[0.28em] uppercase text-[#7FD1E8] font-medium mb-3">Git · The bridge to engineering</p>
          <h2 className="hero-headline text-[40px] md:text-[56px] leading-[0.98]">
            Business semantics<br />
            <span className="text-[#7FD1E8]">become code.</span>
          </h2>
          ...
          <ul className="mt-6 space-y-2 text-[14px] text-slate-300">
            {[
              ...
              <li key={t} className="flex items-center gap-2">
                <span className="w-1.5 h-1.5 rounded-full bg-[#7FD1E8]" />
                {t}
              </li>
            ))}
          </ul>
